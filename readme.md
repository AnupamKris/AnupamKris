...
I am a software engineer, hardware tinkerer, and builder who loves exploring the boundaries of Generative AI, robotics, and automation. When I'm not writing full-stack code, I'm usually building AI tools, desktop assitants or some other random stuffs.
...
A low-latency, hands-free Windows Copilot alternative built using **Google's Multimodal Live API**, **Tauri**, and **React**. It executes native system-level tasks and integrates with the Gmail API for advanced voice-composed email management
